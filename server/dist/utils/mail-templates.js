...
exports.mailTemplates = {
    toUser: {
        appointmentCreated: ({ usersName, serviceName, date, storeAddress, storeEmail, storeName, storePhone, }) => {
      ...
      `;
        ...
        appointmentApproved: ({ date, serviceTitle, storeAddress, storeEmail, storeName, storePhone, userName, }) => {
            const localDate = new Date(date).toLocaleDateString();
            const time = new Date(date).toLocaleTimeString();
      ...
      `;
        ...
        appointmentRejected: ({ date, serviceTitle, storeAddress, storeEmail, storeName, storePhone, userName, }) => {
            const localDate = new Date(date).toLocaleDateString();
            const time = new Date(date).toLocaleTimeString();
      ...
      `;
        ...
        appointmentCompleted: ({ date, serviceTitle, storeAddress, storeEmail, storeName, storePhone, userName, }) => {
            const localDate = new Date(date).toLocaleDateString();
            const time = new Date(date).toLocaleTimeString();
    ...
    toMechanic: {
        appointmentCreated: ({ userName, date, message, userPhone, serviceTitle, userEmail, storeName, }) => {
            const localDate = new Date(date).toLocaleDateString();
            const time = new Date(date).toLocaleTimeString();
      ...
      `;
        ...
        appointmentCompleted: ({ date, serviceTitle, userName, userPhone, userEmail, storeName, }) => {
            const localDate = new Date(date).toLocaleDateString();
            const time = new Date(date).toLocaleTimeString();
            const subject = `Appointment Completed - ${serviceTitle} on ${localDate}`;
            const html = `
